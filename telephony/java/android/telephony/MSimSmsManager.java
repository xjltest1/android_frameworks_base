...
public class MSimSmsManager {
    ...
    public boolean copyMessageToIcc(byte[] smsc, byte[] pdu, int status,
        ...
        try {
            ISmsMSim iccISms = ISmsMSim.Stub.asInterface(ServiceManager.getService("isms_msim"));
            if (iccISms != null) {
                success = iccISms.copyMessageToIccEf(status, pdu,
                                  smsc, subscription);
           }
        } catch (RemoteException ex) {
            // ignore it
   ...
   /**
    ...
    public boolean updateMessageOnIcc(int messageIndex, int newStatus,
        ...
        try {
            ISmsMSim iccISms = ISmsMSim.Stub.asInterface(ServiceManager.getService("isms_msim"));
            if (iccISms != null) {
                success = iccISms.updateMessageOnIccEf(messageIndex, newStatus,
                                  pdu, subscription);
            }
        } catch (RemoteException ex) {
            // ignore it
   ...
   /**
    ...
    public ArrayList<SmsMessage> getAllMessagesFromIcc(int subscription) {
        ...
        try {
            ISmsMSim iccISms = ISmsMSim.Stub.asInterface(ServiceManager.getService("isms_msim"));
            if (iccISms != null) {
                records = iccISms.getAllMessagesFromIccEf(subscription);
            }
        } catch (RemoteException ex) {
            // ignore it
        }
