...
public class IccCardApplicationStatus {
    ...
    public static AppType AppTypeFromRILInt(int type) {
        AppType newType;
        /* RIL_AppType ril.h */
        switch(type) {
    ...
    public static AppState AppStateFromRILInt(int state) {
        AppState newState;
        /* RIL_AppState ril.h */
        switch(state) {
    ...
    public static PersoSubState PersoSubstateFromRILInt(int substate) {
    ...
    public static PinState PinStateFromRILInt(int state) {
